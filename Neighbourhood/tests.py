...
class TestNeighbourhood(TestCase):
    def setUp(self):
        self.new_neigbourhood=NeighbourHood(title = "Title", location="Nyayo", county='Naitobi', neighbourhood_logo="default.jpg", neighbourhood_admin=user)
...
class TestBusiness(TestCase):
    def setUp(self):
        self.new_business=Business(name = "Title", description="Runda", email='Naitobi', neighbourhood="default.jpg", owner=profile)
